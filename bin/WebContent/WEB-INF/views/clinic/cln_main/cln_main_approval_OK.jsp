      ...
      <div style="float: left; width: 400px; margin-left: 150px">
        ...
        <div style="float: left; width: 500px; height: 200px;">
              <ul id="images" class="rs-slider">
                <li class="group">
                  <a href="#">
				            <img src="http://localhost:8080/mkjg/assets/img/main2.jpg" />
				        </a>
                </li>
                <li class="group">
                  <a href="#" class="slide-parent">
				            <img src="http://localhost:8080/mkjg/assets/img/main1.png"/>
				        </a>
                </li>
                <li class="group">
                  <img src="http://localhost:8080/mkjg/assets/img/main3.jpg"/>
                </li>
              </ul>
        </div>
      </div>
